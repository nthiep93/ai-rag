...
exports.getSystemPromptByType = getSystemPromptByType;
...
async function generateAnswer(context, question, systemPrompt) {
    if (!OPENAI_API_KEY) {
        throw new Error("OPENAI_API_KEY is not set. Please add your API key to .env");
    }
    ...
    try {
        ...
        console.log(`  ✅ Answer generated (${usage.completion_tokens} completion tokens)`);
        return {
            answer: message,
            usage: {
 ...
 */
function getSystemPromptByType(docType) {
